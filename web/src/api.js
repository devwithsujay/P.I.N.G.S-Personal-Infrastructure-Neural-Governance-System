...
export const getHomelabStatus = () => client.get('/homelab/status')
export const testSshConnection = (data) => client.post('/homelab/ssh/test', data)
export const saveSshConfig = (data) => client.put('/homelab/ssh', data)
export const containerAction = (action, name) => client.post(`/homelab/containers/${action}/${name}`)

export const getAutomations = () => client.get('/automations')
export const createAutomation = (data) => client.post('/automations', data, { headers: { 'Content-Type': 'multipart/form-data' } })
export const updateAutomation = (id, data) => client.patch(`/automations/${id}`, data, { headers: { 'Content-Type': 'multipart/form-data' } })
export const deleteAutomation = (id) => client.delete(`/automations/${id}`)
export const getAutomationRuns = (id) => client.get(`/automations/${id}/runs`)
export const runAutomation = (id) => client.post(`/automations/${id}/run`)
