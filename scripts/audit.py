...
class PingsCoreAuditor:
    ...
    def audit_env_example(self):
        ...
        for var in required_vars:
            if re.search(rf"^\s*{var}=" if var != "BRAIN_SECRET_KEY" else r"^\s*{var}=" if var != "BRAIN_SECRET_KEY" else r"^\s*{var}=" if var != "BRAIN_SECRET_KEY" else r"^\s*{var}=" if var != "BRAIN_SECRET_KEY" else r"^\s*{var}=" if var != "BRAIN_SECRET_KEY" else r"^\s*{var}=", content, re.MULTILINE):
